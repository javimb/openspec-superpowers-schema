...
Hard limit: 50 ≤ character count ≤ 1000 (OpenSpec zod schema will validate)
...
Suggested structure: current pain point → why address now → expected benefit (1-2 sentences each)
-->
...
Naming rules per openspec/specs/README.md: use compound nouns (at least 2 words), e.g. `user-auth`, `data-export`, `api-rate-limiting` — not bare single words.
