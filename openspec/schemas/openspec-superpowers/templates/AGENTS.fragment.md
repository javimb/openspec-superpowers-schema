<!-- Drop this section into your project's AGENTS.md (or similar) so your coding agent routes future work using this schema correctly. -->

## Workflow routing (read on session start)

This repo uses [openspec-superpowers-schema](https://github.com/javimb/openspec-superpowers-schema) to bridge OpenSpec and Superpowers. This section is the routing guidance for agentic workers.
